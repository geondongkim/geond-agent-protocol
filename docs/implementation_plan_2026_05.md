...
- VS Code Copilot importer usage extraction을 시작했습니다. `import-vscode`는 chat/transcript raw record의 usage block을 먼저 찾고, 없으면 chat line 기반 session estimate를 기록합니다.
